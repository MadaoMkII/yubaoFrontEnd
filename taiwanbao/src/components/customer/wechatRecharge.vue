<template>
	<div class="wechatRecharge">
		...
		<div>
			...
			<div class="row nomargin hidden-lg hidden-md" style="margin: 0;background: #ff8500;">
				<div class="col-sm-4 col-xs-4 col-sm-offset-4 col-xs-offset-4">
					<p style="margin-bottom: 0;line-height: 42px;color: #fff;">微信儲值</p>
				</div>
						...
						<div class="col-lg-12 col-md-12 nopadding" style="height: 40px;background: rgba(0,166,255,0.5);border: 0.5px solid #00a6ff;border-radius: 10px;">
							<div class="row nomargin hidden-sm hidden-xs">
								<div style="width: 80%;margin: 0 auto;">
									...
									<p class="pull-left actionTxt">創建微信儲值訂單</p>
					...
					<div class="row nomargin" style="margin-top: 20px;padding-bottom: 30px;">
						<div class="col-lg-8 col-md-8" style="padding: 0;border: 0.5px solid #ccc; background:#fff;">
						  <div id="step1" style="display:block;">
							<div class="row nomargin" style="margin-top: 20px;">
								<div class="col-lg-12 col-md-12">
									<p class="pull-left nomargin" style="font-size: 16px;color: #333;margin-right: 15px;font-weight: bold;">請選擇微信帳戶</p>
								</div>
							</div>
							<div class="row nomargin" style="margin-top: 10px;">
								<a href="javascript:void(0)">
									<div  style="border: 1px solid #ccc;padding: 15px;margin: 5px 15px;" v-for="(item,index) in wechatAccountArray" @click="chooseWechatAccount(item,index)" :class="divIndex==index?'activeDiv col-lg-2 col-md-2 col-sm-4 col-xs-4 nopadding':'col-lg-2 col-md-2 col-sm-4 col-xs-4 nopadding'">
										<center><img :src="item.profileImgUrl" style="width: 80%;"/></center>
										<center v-if="item.hasRealNameAuthed"><button type="button" class="btn btn-success" style="font-size: 12px;padding: 3px 12px;margin-top: 5px;">已實名</button></center>
										<center v-if="!item.hasRealNameAuthed"><button type="button" class="btn btn-warning" style="font-size: 12px;padding: 3px 12px;margin-top: 5px;">未實名</button></center>
										<center><p class="nomargin" style="overflow: hidden;text-overflow: ellipsis;white-space: nowrap;font-size: 12px;color: #333;margin-top: 5px;">{{item.nickname}}</p></center>
									</div>
									<div class="col-lg-2 col-md-2 col-sm-4 col-xs-4 nopadding" style="margin: 5px 15px;">
										<center><router-link to="center" class="btn btn-default" style="color: #00a6ff;border: 0.5px solid #00a6ff;font-size: 10px;padding: 3px 12px;margin-top: 50%;"><img src="../../assets/images/newusericon.png" style="width: 10px;margin-right: 5px;"/>新增帳戶</router-link></center>
									</div>
								</a>
							</div>
							<div class="row nomargin" style="margin-top: 10px;">
								<div class="col-lg-12 col-md-12">
									<input type="checkbox" id="alreadyConfirm"  class="pull-left" style="margin-right: 15px;"/>
									<p class="nomargin pull-left" style="text-align: left;width: 90%;">我確認要儲值的帳號可以正常收付款項，並了解儲值完成後無法退款</p>
								</div>
							</div>
							<div class="row nomargin" style="margin-top: 20px;">
								<div class="col-lg-12 col-md-12">
									<p class="pull-left nomargin" style="font-size: 16px;color: #333;margin-right: 15px;font-weight: bold;text-align: left;">微信儲值金額</p>
									...
									<p class="pull-right nomargin" style="font-size: 10px;color: #999;margin-top: 5px; margin-top: 5px; margin-right:80px;text-align: left;">注意：R幣只能用於代付業務，R幣無法返回台幣，1R幣=1人民幣</p>
								</div>
							</div>
							...
							<div class="row nomargin hidden-lg hidden-md" style="margin-top: 10px;">
								<div class="col-lg-12 col-md-12">
									<input type="text" name="" id="" value="" v-model="RMBAmount" class="form-control" placeholder="請輸入人民幣金額"/>
								</div>
							</div>
							<div class="row nomargin" style="margin-top: 20px;">
								<div class="col-lg-12 col-md-12">
										...
										<div class="row nomargin" style="margin-top: 10px;">
											<p class="pull-left nomargin" style="font-size: 12px;color: #333;text-align: left;">網路ATM/ATM櫃員機<span style="font-size: 10px;color: #999;">（銀行帳戶詳情在送出訂單后可見）</span></p>
										</div>
										<div class="row nomargin" style="margin-top: 10px;">
											<div class="col-lg-1 col-md-1 col-sm-2 col-xs-2" style="padding-right: 0;">
												<input type="radio" name="typeStr"  value="812 台新商銀 收款帳戶 002857" v-model="typeStr" class="pull-left" style="margin-top: 10px;"/>
											</div>
											<div class="col-lg-11 col-md-11 col-sm-10 col-xs-10" style="padding-left: 0;">
												<div class="row nomargin">
													...
													<div class="col-lg-11 col-md-11 col-sm-9 col-xs-9 nopadding">
														<div class="row nomargin">
															<p class="pull-left" style="margin: 0;font-size: 12px;">812 台新商銀 收款帳戶 002857</p>
														</div>
														<div class="row nomargin">
										...
										<div class="row nomargin" style="margin-top: 20px;">
											<div class="col-lg-1 col-md-1 col-sm-2 col-xs-2" style="padding-right: 0;">
												<input type="radio" name="typeStr"  value="822 中國信託 收款帳戶 141191" v-model="typeStr" class="pull-left" style="margin-top: 10px;"/>
											</div>
											<div class="col-lg-11 col-md-11 col-sm-10 col-xs-10" style="padding-left: 0;">
												<div class="row nomargin">
													<div class="col-lg-1 col-md-1 col-sm-3 col-xs-3 nopadding">
														<center><img src="../../assets/images/xintuo.jpg" class="pull-left" style="width: 80%;border-radius: 50%;"/></center>
													</div>
													<div class="col-lg-11 col-md-11 col-sm-9 col-xs-9 nopadding">
														<div class="row nomargin">
															<p class="pull-left" style="margin: 0;font-size: 12px;">822 中國信託 收款帳戶 141191</p>
														</div>
														<div class="row nomargin">
															<p class="pull-left" style="margin: 0;color: #e00;font-size: 12px;">支援全臺各家銀行轉入</p>
														</div>
						  ...
						  <div id="step2" style="display: none;">
								...
								<div class="row nomargin" style="margin-top: 20px;">
									<div class="col-lg-12 col-md-12">
										<p class="pull-left" style="font-size: 20px;font-weight: bold;text-align: left;">儲值到微信帳戶：</p>
									</div>
								</div>
								<div class="row nomargin" >
									<div class="col-lg-12 col-md-12" style="padding: 0;">
										<div  style="border: 1px solid #ccc;padding: 15px;margin: 5px 15px;"  class="col-lg-2 col-md-2 col-sm-4 col-xs-4 nopadding">
								...
								<div class="row nomargin" style="margin-top: 20px;">
									<div class="col-lg-12 col-md-12">
										<p class="pull-left" style="font-size: 20px;font-weight: bold;text-align: left;">您選擇的付款方式：<span style="margin-left: 15px;">ATM銀行轉賬 </span></p>
										<button class="btn btn-default pull-left" style="color: #00a6ff;border: 0.5px solid #00a6ff;font-size: 10px;padding: 3px 12px; margin-left:20px; margin-top:2px;" @click="popUpAddBank"><img src="../../assets/images/newusericon.png" style="width: 10px;margin-right: 5px;"/>新增帳戶</button>	
									</div>
								</div>
								<div class="row nomargin" style="margin-top: 15px;">
									<div class="col-lg-12 col-md-12">
										<div class="row nomargin">
											<p class="pull-left" style="color: #999;font-size: 12px;">您的付款銀行帳戶</p>
										</div>
										<div class="row nomargin">
											<div class="col-lg-12 col-md-12" style="border: 1px solid #ccc;border-radius: 5px;padding: 0;">
												<div class="row nomargin" style="background: #f5f5f5;padding: 4px 15px;border-top-left-radius: 5px;border-top-right-radius: 5px; border-bottom:1px solid #ccc;">
													<div class="row nomargin" v-for="item in userInfo.bankAccounts">
														...
														<a href="javascript:void(0)"  class="pull-left"  style="color: #2a6baf;margin-right: 10px;line-height: 22px; text-align: left;" v-if="chooseBank==item.accountName"><img src="../../assets/images/chooseIcon.png"/>約定帳戶</a>
													</div>
												</div>
							...
							<div id="step3" style="display: none;">
								<div class="row nomargin" style=" border-bottom:1px solid #dbdbdb; ">
									<div class="col-lg-12 col-md-12">
										...
										<a class="pull-right hidden-sm hidden-xs" style="color: #999;margin-right: 10px; line-height: 50px;text-align: left;">我們正在拼命為您代付，請稍等！</a>
										<a class="pull-left hidden-lg hidden-md" style="color: #999;margin-right: 10px; line-height: 50px;text-align: left;">我們正在拼命為您代付，請稍等！</a>
								...
								<div class="row nomargin" style="margin-top: 15px;">
									<div class="col-lg-12 col-md-12 table-responsive" style="padding: 10px;">
										<table class="table table-striped tableForBills" style="border:1px solid #dbdbdb;">
											<thead>
												<tr>
													<th>订单金额</th>
								...
								<div class="row nomargin" style="margin-top: 20px;">
									<div class="col-lg-12 col-md-12">
										<p class="pull-left" style="font-size: 20px;font-weight: bold;">儲值到微信帳戶：</p>
									</div>
								</div>
								<div class="row nomargin" >
									<div class="col-lg-12 col-md-12" style="padding: 0;">
										...
										<div class="row nomargin">
											<div class="col-lg-12 col-md-12" style="border: 1px solid #ccc;border-radius: 5px;padding: 0;">
												<div class="row nomargin" style="background: #f5f5f5;padding: 0 15px;border-top-left-radius: 5px;border-top-right-radius: 5px;">
													<a href="javascript:void(0)" class="pull-left" style="color: #08bf69;margin-right: 10px;line-height: 30px;text-align: left;">{{userBankName}}({{userLastSix}})</a>
												</div>
											</div>
										</div>
										<div class="row nomargin" style="margin-top: 20px;">
		...
		<!--<div class="hidden-lg hidden-md">
			...
			<div class="row nomargin" style="margin: 0;margin-top: 1em;">
				<div class="col-sm-12 col-xs-12">
					<p class="pull-left nomargin" style="font-size: 1.1em;color: #333;margin-right: 1em;font-weight: bold;">請選擇微信帳戶</p>
				</div>
			</div>
			<div class="row nomargin" style="margin: 0;margin-top: 1em;">
				<a href="javascript:void(0)">
					<div class="col-sm-3 col-xs-3 nopadding" style="margin: 0.5em;border: 0.05em solid #ccc;padding: 0.5em;">
						<center><img src="../../assets/images/mobile/touxiang.png" style="width: 80%;"/></center>
						<center><button type="button" class="btn btn-success" style="font-size: 0.8em;padding: 3px 12px;">已實名</button></center>
						<center><p class="nomargin" style="overflow: hidden;text-overflow: ellipsis;white-space: nowrap;font-size: 0.8em;color: #333;margin-top: 0.5em;">微信實名微信實名</p></center>
					</div>
				</a>
				<div class="col-sm-3 col-xs-3 nopadding" style="margin: 0.5em;padding: 0.5em;">
					<router-link to="center" class="btn btn-default" style="border: 0.05em solid #00a6ff;color: #00a6ff;margin-top: 35%;">
			...
			<div class="row nomargin" style="margin: 0;margin-top: 1em;">
				<div class="col-sm-1 col-xs-1" style="padding-right: 0;">
					<center><input type="checkbox" name="" id="" value="" class="pull-left"/></center>
				</div>
				<div class="col-sm-11 col-xs-11">
					<p class="nomargin pull-left" style="text-align: left;">我確認要儲值的帳號可以正常收付款項，並了解儲值完成後無法退款</p>
				</div>
			</div>
			<div class="row nomargin" style="margin: 0;margin-top: 1em;">
				<div class="col-sm-12 col-xs-12">
					<p class="pull-left nomargin" style="font-size: 1.1em;color: #333;margin-right: 1em;font-weight: bold;">微信儲值金額</p>
			...
			<div class="row nomargin" style="margin: 0;margin-top: 0.5em;">
				<div class="col-sm-12 col-xs-12">
					<p class="pull-left nomargin" style="font-size: 1em;color: #333;">網路ATM/ATM櫃員機<span style="font-size: 0.8em;color: #999;">（銀行帳戶詳情在送出訂單后可見）</span></p>
				</div>
			</div>
			<div class="row nomargin" style="margin: 0;">
				<div class="col-sm-12 col-xs-12 nopadding" style="border: 0.05em solid #ccc;border-left: none;border-right: none;">
					...
					<p class="pull-left" style="font-size: 1em;margin-top: 0.8em;">700 郵局 收款帳戶 47936</p>
				</div>
			</div>
			<div class="row nomargin" style="margin: 0;">
				<div class="col-sm-12 col-xs-12 nopadding" style="border: 0.05em solid #ccc;border-left: none;border-right: none;">
					...
					<p class="pull-left" style="font-size: 1em;margin-top: 0.8em;">808 玉山商銀 收款帳戶 175242</p>
				</div>
			</div>
			<div class="row nomargin" style="margin: 0;">
				<div class="col-sm-12 col-xs-12 nopadding" style="border: 0.05em solid #ccc;border-left: none;border-right: none;">
			...
			<div class="row nomargin" style="margin: 0;margin-top: 1em;">
				<div class="col-sm-12 col-xs-12">
					<center><input type="checkbox" name="" id="" value="" style="margin-right: 0.5em;margin-top: 0.2em;"/>我已閱讀并同意<a href="javascript:void(0)">「結匯授權同意書」</a></center>
				</div>
			</div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="padding: 0;">
                  ...
                  <div class="row nomargin" style="margin-top: 15px;">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="background: #ffe7cc;border-radius: 10px;padding: 15px;">
                      <p class="pull-left" style="margin: 0;text-align: left;">付款銀行帳戶新增后不可刪除，銀行帳號為【存簿】帳號，切勿填成信用卡卡號。</p>
                      <p class="pull-left" style="margin: 0;text-align: left;">請勿綁定他人帳號，若產生爭議請私下處理，玉寶概不介入！</p>
                    </div>
                  </div>
                  ...
                  <div class="row nomargin" style="margin-top: 15px;">
                    <div class="col-lg-2 col-md-2" style="padding: 0 15px;">
                      <label class="pull-right hidden-sm hidden-xs" style="line-height: 34px;">帳號末六位碼：</label>
                      <label class="pull-left hidden-lg hidden-md" style="line-height: 34px;">帳號末六位碼：</label>
                    </div>
                    <div class="col-lg-10 col-md-10" style="padding: 0 15px;">
...
<script>
	...
	export default {
	  ...
	  methods:{
	  	...
	  	chooseWechatAccount(item,index){
	  		this.wechatAccountItem = item;
	  		this.divIndex = index;
	  	},
	  	...
	  	getLowPaymount(){
	  		...
	  		$.ajax({
			    ...
			    success:function (res) {
			    	if (res.error_code == 200 || res.error_code == 0) {
			    		that.lowPay = res.data.threshold?res.data.threshold.wechat:0;
			    	}
			    }
	  		});
	  		...
	  		$.ajax({
			    ...
			    success:function (res) {
			    	if (res.error_code == 0 || res.error_code==200) {
			    		...
			    		this.wechatAccountArray = res.data.wechatAccounts;
	  	...
	  	nextStep:function () {
	  		if(this.divIndex==-1 || this.wechatAccountItem==null){
	  			layer.msg('請選擇微信帳戶',{icon:5});
	  			return;
	  		}
		...
		　　} 
	  	...
	  	finalStep:function () {
	  		...
	  		var param = {
				...
				chargeInfo:{ 
					chargeFromAccount: this.userLastSix,
					toOurAccount:this.typeStr.split(' ')[0]
				},
				rechargeInfo:{ 
					rechargeToAccount: this.wechatAccountItem.wechatID
				}
	  		}
	  		$.ajax({
	  			type:'post',
	  			url:getService()+"/recharger/addChargeWechatBills",
	  			dataType: "json",
	  			data:JSON.stringify(param),
	  			async:true,
				headers: {'Content-Type': 'application/json'},
				    	...
				    	for(var i=0;i<this.bankDetail.length;i++){
				    		if(this.bankDetail[i].bankCode == this.typeStr.split(' ')[0]){
				    			this.finalbankDetailInfo.account=this.bankDetail[i].bankCode+' '+
				    				this.bankDetail[i].bankName+' '+'收款帳號'+this.bankDetail[i].accountCode;
