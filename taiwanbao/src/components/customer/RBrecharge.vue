		...
		<div>
			...
			<div class="row nomargin hidden-lg hidden-md" style="margin: 0;background: #ff8500;">
				<div class="col-sm-4 col-xs-4 col-sm-offset-4 col-xs-offset-4">
					<p style="margin-bottom: 0;line-height: 42px;color: #fff;">R幣儲值</p>
				</div>
        		<mobileList></mobileList>
			</div>
			<div class="row nomargin" style="margin: 0;margin-top: 20px;margin-bottom: 50px;">
				<div class="col-lg-8 col-md-8 col-lg-offset-2 col-md-offset-2 nopadding">
						...
						<div class="col-lg-12 col-md-12 nopadding" style="height: 40px;background: rgba(0,166,255,0.5);border: 0.5px solid #00a6ff;border-radius: 10px; ">
							<div class="row nomargin hidden-sm hidden-xs">
								<div style="width: 80%;margin: 0 auto;">
									...
									<p class="pull-left actionTxt">創建R幣儲值訂單</p>
					...
					<div class="row nomargin" style="margin-top: 20px;">
						<div class="col-lg-8 col-md-8" style="border: 0.5px solid #ccc;padding: 0 15px;background:#fff; ">
							<div id="step1" style="display:block;">
								<div class="row nomargin" style="margin-top: 20px;">
									<div class="col-lg-12 col-md-12">
										<p class="pull-left nomargin" style="font-size: 16px;color: #333;margin-right: 15px;font-weight: bold;">R幣儲值金額</p>
										<p class="pull-left nomargin" style="font-size: 12px;color: #398439;margin-top: 5px;margin-right: 5px;">{{userInfo.VIPLevel}}</p>
								...
								<div class="row nomargin" style="margin-top: 10px;">
									<div class="col-lg-12 col-md-12 ">
								        ...
								        <div class="row hidden-lg hidden-md">
								        	<input type="text" v-model="RMBAmount" class="form-control" @focus="inputfocus" @blur="inputblur" placeholder="请输入商品的人民币金额">
								        </div>
									...
									<div class="col-lg-12 col-md-12">
										...
										<div class="row nomargin" style="margin-top: 10px;">
											<div class="col-lg-1 col-md-1 col-sm-2 col-xs-2" style="padding-right: 0;">
												<input type="radio" name="typeStr"  value="812 台新商銀 收款賬戶 002857" v-model="typeStr" class="pull-left" style="margin-top: 10px;"/>
											</div>
											<div class="col-lg-11 col-md-11 col-sm-10 col-xs-10" style="padding-left: 0;">
												<div class="row nomargin">
													...
													<div class="col-lg-11 col-md-11 col-sm-9 col-xs-9 nopadding">
														<div class="row nomargin">
															<p class="pull-left" style="margin: 0;font-size: 12px;text-align: left;">812 台新商銀 收款賬戶 002857</p>
														</div>
														<div class="row nomargin">
										...
										<div class="row nomargin" style="margin-top: 20px;">
											...
											<div class="col-lg-11 col-md-11 col-sm-10 col-xs-10" style="padding-left: 0;">
												<div class="row nomargin">
													...
													<div class="col-lg-11 col-md-11 col-sm-9 col-xs-9 nopadding">
														<div class="row nomargin">
															<p class="pull-left" style="margin: 0;font-size: 12px;text-align: left;">822 中國信託 收款賬戶 141191</p>
														</div>
														<div class="row nomargin">
															<p class="pull-left" style="margin: 0;color: #e00;font-size: 12px;text-align: left;">支援全臺各家銀行轉入</p>
														</div>
									...
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 table-responsive" style="padding: 0;">
										<table class="table table-striped tableForBills" style="border:1px solid #dbdbdb;" >
											<thead style="background:#f5f5f5; ">
												<tr>
													<th style="width: 25%;">訂單金額</th>
													<th style="width: 25%;">匯率</th>
													<th style="width: 25%;">手續費</th>
													<th style="width: 25%;">應付新台幣</th>
												</tr>
											</thead>
											<tbody >
												<tr style="background:#ffffff; padding:0 15px;">
													<td style="width: 25%;">¥<span style="font-size: 20px;">{{RMBAmount}}</span>RMB</td>
													<td style="width: 25%;">{{rate}}</td>
													<td style="width: 25%;">¥{{(feeRate/100*RMBAmount).toFixed(2)}}RMB</td>
													<td style="width: 25%;">$<span style="font-size: 20px;">{{totalAmount}}</span>TWD</td>
												</tr>
											</tbody>
										</table>
									</div>
									...
									<div class="col-lg-12 col-md-12">
										...
										<div class="row nomargin">
											<div class="col-lg-12 col-md-12" style="border: 1px solid #ccc;border-radius: 5px;padding: 0;">
												<div class="row nomargin" style="background: #f5f5f5; border-top-left-radius: 5px;border-top-right-radius: 5px;">
						...
						<div class="col-lg-4 col-md-4 hidden-sm hidden-xs" style="padding-right: 0;">
							<div class="row nomargin" style="border: 0.5px solid #ccc;padding: 0 15px; background:#fff;">
								<div class="col-lg-12 col-md-12">
									<div class="row nomargin" style="margin-top: 20px;">
									...
									<div class="row nomargin" style="margin-top: 15px;">
										<div class="col-lg-6 col-md-6 nopadding">
											<p class="pull-left nomargin" style="font-size: 12px;color: #333;">我要支付新台币：</p>
										</div>
										<div class="col-lg-6 col-md-6 nopadding">
							...
							<div class="row nomargin" style="border: 0.5px solid #ccc;margin-top: 20px;padding: 20px 15px; background:#fff;">
								<div class="col-lg-12 col-md-12">
									<div class="row nomargin">
		...
		<!--<div class="hidden-lg hidden-md">
			<div class="row nomargin" style="background: #ff8500;">
				<div class="col-sm-12 col-xs-12">
					<div class="dropdown">
						<p class="pull-left" style="font-size: 1em;color: #fff;margin-left: 50%;position: relative;left: -2em;margin-top: 1em;">R幣儲值</p>
			...
			<div class="row nomargin" style="margin-top: 1em;">
				<div class="col-sm-12 col-xs-12">
					<p class="pull-left nomargin" style="font-size: 1.1em;color: #333;margin-right: 1em;font-weight: bold;">R幣儲值金額</p>
					<p class="pull-left nomargin" style="font-size: 1em;color: #666;margin-top: 0.1em;">匯率<span style="color: #398439;margin-left: 0.5em;">{{rate}}</span></p>
			...
			<div class="row nomargin" style="margin-top: 1em;">
				<div class="col-sm-12 col-xs-12">
					<center><input type="checkbox"  id="alreadyReadTwo" style="margin-right: 0.5em;margin-top: 0.2em;"/>我已閱讀并同意<a href="javascript:void(0)">「結匯授權同意書」</a></center>
				</div>
			</div>
	  ...
	  methods:{
	  		...
	  		$.ajax({
			    ...
			    success:function (res) {
			    	if (res.error_code == 200 || res.error_code == 0) {
			    		that.lowPay = res.data.threshold?res.data.threshold.platform:0;
			    	}
			    }
	  		});
		...
		　　}
	  	...
	  	finalStep:function () {
	  		...
	  		$.ajax({
	  			type:'post',
	  			url:getService()+"/recharger/addRcoinChargeBill",
	  			dataType: "json",
	  			data:JSON.stringify(param),
	  			async:true,
				headers: {'Content-Type': 'application/json'},
